...
export default function ActionButtons({ onRefresh, isRefreshing }: ActionButtonsProps) {
  return (
    <div className="flex space-x-4 pt-4">
      ...
      <button 
        className="flex-1 bg-white text-gray-dark py-3 px-6 rounded-xl font-semibold shadow-lg border border-gray-300 hover:bg-gray-50 transform transition-all duration-200 hover:scale-105 active:scale-95"
